package ru.mirea.aod_practice16;
    ...
    public static void main(String[] args) {
        ...
        for (double[] doubles : table_result) {
            for (int j = 0; j < table_result[0].length; j++)
                System.out.print(String.format("%f\t",doubles[j]));

            System.out.println();
        }
        System.out.println(String.format("x0 = %f",result[0]));
        System.out.println(String.format("x1 = %f",result[1]));
        System.out.println(String.format("x2 = %f",result[2]));
    }
}
